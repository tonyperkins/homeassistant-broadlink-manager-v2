...
## [Unreleased]
## [0.5.0-beta.17] - 2026-07-18

### Fixed
- Fix SmartIR cross-fork compatibility: save profiles to both codes/ and custom_codes/ directories


## [0.5.0-beta.16] - 2026-07-17

### Fixed
- Fix SmartIR climate profile editing: sensor persistence, off mode restore, Commands button step


## [0.5.0-beta.15] - 2026-07-09

### Fixed
- Fix climate entity generation feedback and diagnostics improvements


## [0.5.0-beta.14] - 2026-07-06

### Fixed
- Fix clipboard copy and file download on mobile/HA Ingress


## [0.5.0-beta.13] - 2026-07-05

### Fixed
- Document package_output_path, remember RF frequency, IR/RF labels


## [0.5.0-beta.12] - 2026-07-05

### Fixed
- Update IR/RF labels and auto-select single remote device


## [0.5.0-beta.11] - 2026-07-04

### Fixed
- Fix SmartIR climate JSON nesting order - temperature as leaf value (#40)


## [0.5.0-beta.10] - 2026-07-04

### Fixed
- Fix paste code field validation - only required for Import Code


## [0.5.0-beta.9] - 2026-07-04

### Fixed
- Add command export/import, blaster reassignment, and dialog fixes
...
## [0.5.0-beta.5] - 2026-05-14

### Fixed
- Fix web server ignoring web_port config: read port from config instead of hardcoding 8099


## [0.5.0-beta.4] - 2026-05-10

### Fixed
- Fix web_port not persisting: add web_port to config.yaml schema


## [0.5.0-beta.3] - 2026-05-09

### Fixed
- Fix remaining raw entity_id usage in cover position and climate helper references


## [0.5.0-beta.2] - 2026-05-09

### Fixed
- Fix invalid entity IDs for media player companion switches and cover helpers when device names contain spaces


## [0.5.0-beta.1] - 2026-05-08

### Fixed
- Add package_output_path config option for !include_dir_named packages integration
...
### Fixed
- Fix area sync for devices with spaces in names


## [0.4.0-beta.16] - 2026-04-09

### Fixed
- Fix bulk area sync with sequential execution and progress dialog
...
### Fixed
- Rebuild frontend with correct version display


## [0.4.0-beta.13] - 2026-03-29

### Fixed
- Fix SmartIR JSON key ordering issue (#32)


## [0.4.0-beta.12] - 2026-03-29

### Fixed
- Fix version mismatch and update release workflow


## [0.4.0-beta.11] - 2026-03-29

### Fixed
- Add stateless device mode for one-way control devices


## [0.4.0-beta.10] - 2026-03-27

### Fixed
- Add custom fan and swing mode support to climate profile builder


## [0.4.0-beta.9] - 2026-03-27

### Fixed
- Fix SmartIR index update timeout causing false errors


## [0.4.0-beta.8] - 2026-03-26

### Fixed
- Fix: Rebuild frontend to display correct version number


## [0.4.0-beta.7] - 2026-03-20

### Fixed
- Add color temperature variant support for lights with multiple presets
...
### Fixed
- Fix source selection - use template instead of invalid choose action for universal media player


## [0.4.0-beta.4] - 2026-02-06

### Fixed
- Fix entity generation - media player commands now use base64 IR/RF data instead of command names


## [0.4.0-beta.3] - 2026-02-05

### Fixed
- Fix fan profile editing - learned commands now display correctly in edit mode


## [0.4.0-beta.2] - 2026-02-05

### Fixed
- Fix fan profile editing - learned commands now display correctly in edit mode


## [0.4.0-beta.1] - 2026-02-02

### Fixed
- Add command import/paste feature, toggle support for media players, and entity generation validation warnings
...
[Unreleased]: https://github.com/tonyperkins/homeassistant-broadlink-manager-v2/compare/v0.5.0-beta.9...HEAD
