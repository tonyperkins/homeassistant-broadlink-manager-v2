...
This file provides support for Broadlink-based climate devices, allowing them to be
controlled through Home Assistant.
"""
...
class SensorMode(IntEnum):
    """Defines the thermostat's sensor control modes."""
...
class BroadlinkThermostat(BroadlinkEntity, ClimateEntity):
    """Represents a Broadlink Hysen climate entity."""
    ...
    async def async_set_temperature(self, **kwargs: Any) -> None:
        ...
        Args:
            **kwargs: The keyword arguments, containing the temperature.
        """
