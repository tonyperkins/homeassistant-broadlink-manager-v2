...
This file manages the setup process for Broadlink devices, handling discovery,
...
class BroadlinkFlowHandler(ConfigFlow, domain=DOMAIN):
    ...
    async def async_set_device(
        ...
        Args:
            ...
            raise_on_progress: Whether to raise an exception if the flow is already in progress.
        """
    ...
    async def async_step_dhcp(
        ...
        Args:
            discovery_info: The DHCP discovery information.
    ...
    async def async_step_user(
        ...
        Args:
            user_input: The user-provided input.
    ...
    async def async_step_finish(
        ...
        """Choose a name for the device and create a config entry.
    ...
    async def async_step_import(self, import_data: dict[str, Any]) -> ConfigFlowResult:
        """Import a device from configuration.yaml.

        Args:
            import_data: The import data.
